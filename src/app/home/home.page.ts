...
export class HomePage {
  ...
  ionViewDidEnter () {
    this.map = L.map('mapId').setView([-7.779612902581501, 110.3767793237515], 11)
    ...
    const marker1 = L.marker([-7.173279631142999, 109.98700696434568], {icon: customIcon }).addTo(this.map);
    marker1.bindPopup("Jawa Tengah").openPopup();
    ...
    const overlayMaps = {
      'provinsi': L.layerGroup([marker, marker1])
    }
